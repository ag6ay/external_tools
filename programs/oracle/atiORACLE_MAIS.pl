...
##               Last Updated: PS - 04/02/2012 Ver. 1.01                      ##
##                                                                            ##
################################################################################
################################################################################
use strict;
...
################################################################################
$vars{'TNSNAME'}     = 'e23441';          #Required
$vars{'USERNAME'}    = 'mais_user';          #Required
$vars{'PASSWORD'}    = 'Maistest123';          #Required


################################################################################
# SQL String
################################################################################
$vars{'SQL_STRING'}         = "SELECT * from MAIS.MESSAGE_PLAN";
