...
################################################################################
##                                                                            ##
##  maisGTMTests.pl - MAIS GTM smoke tests used to validate MAIS              ##
##                    is functional against Global Traffic Manager.           ##
##                                                                            ##
##                   Created by: David Schwab                                 ##
##                   Last updated: DS - 04/14/2014 Ver. 1.0                   ##
##                                                                            ##
##                                                                            ##
################################################################################
################################################################################
...
#################################################################
$vars{'qa_qdc'}{'guid'}                          = 'c0a82a2600fa00224f99c0cb07afe700';
$vars{'qa_qdc'}{'fiid'}                          = '00460';
$vars{'qa_qdc'}{'url'}                           = 'http://pqalmsgas-vip.corp.intuit.net';
$vars{'qa_qdc'}{'auth'}                          = 'maistestclient';

#################################################################
#Define qal1_dca_dcb Variables below
#################################################################
$vars{'qal1_dca_dcb'}{'guid'}                    = 'c0a82a2600fa00224f99c0cb07afe700';
$vars{'qal1_dca_dcb'}{'fiid'}                    = '00460';
$vars{'qal1_dca_dcb'}{'url'}                     = 'http://msg.qal1.diginsite.net';
...
$vars{'beta_qdc'}{'url'}                         = 'http://pprdmsgas-beta-vip.ie.intuit.net';
...
$vars{'stg1_dca'}{'url'}                         = 'http://msg.stg1.diginsite.net';
...
$vars{'prod_qdc_lvdc'}{'url'}                    = 'http://message-prd-banking.ilb.intuit.com';
...
$vars{'prd1_dca_dcb'}{'url'}                     = 'http://msg.prd1.diginsite.net';
...
if (1)
{
   ...
   #Send Request
   ($httpResCode, $httpResponseHeader, $httpResponseBody, $httpResponse) = httpRequest("$vars{$env}{'url'}/mais/status", \%httpHeaderHash, $agent, $readTimeOut, $httpContentType, 'GET', $httpBody, $outboundProxy);
...
if (1)
{
   ...
   #Send Request
   ($httpResCode, $httpResponseHeader, $httpResponseBody, $httpResponse) = httpRequest("$vars{$env}{'url'}/mais/v1/fis/$vars{$env}{'fiid'}/messagePlans", \%httpHeaderHash, $agent, $readTimeOut, $httpContentType, 'GET', $httpBody, $outboundProxy);
...
{
   #Set Test Name
   $testName = 'getMessageEventTypes-v1';
   ...
   #Send Request
   ($httpResCode, $httpResponseHeader, $httpResponseBody, $httpResponse) = httpRequest("$vars{$env}{'url'}/mais/v1/fis/$vars{$env}{'fiid'}/messageEventTypes", \%httpHeaderHash, $agent, $readTimeOut, $httpContentType, 'GET', $httpBody, $outboundProxy);
...
{
   #Set Test Name
   $testName = 'getMessageLocations-v1';
   ...
   #Send Request
   ($httpResCode, $httpResponseHeader, $httpResponseBody, $httpResponse) = httpRequest("$vars{$env}{'url'}/mais/v1/fis/$vars{$env}{'fiid'}/messageLocations", \%httpHeaderHash, $agent, $readTimeOut, $httpContentType, 'GET', $httpBody, $outboundProxy);
...
if (1)
{
   ...
   #Send Request
   ($httpResCode, $httpResponseHeader, $httpResponseBody, $httpResponse) = httpRequest("$vars{$env}{'url'}/mais/v1/fis/$vars{$env}{'fiid'}/fiCustomers/$vars{$env}{'guid'}/subscriptions", \%httpHeaderHash, $agent, $readTimeOut, $httpContentType, 'GET', $httpBody, $outboundProxy);
...
{
   #Set Test Name
   $testName = 'getSubscriptionsByFI-v1';
   ...
   #Send Request
   ($httpResCode, $httpResponseHeader, $httpResponseBody, $httpResponse) = httpRequest("$vars{$env}{'url'}/mais/v1/fis/$vars{$env}{'fiid'}/subscriptions", \%httpHeaderHash, $agent, $readTimeOut, $httpContentType, 'GET', $httpBody, $outboundProxy);
...
{
   #Set Test Name
   $testName = 'fetchUniqueGroupCodes-MessageEventTypes-v1';
...
if (1)
{
   ...
   #Send Request
   ($httpResCode, $httpResponseHeader, $httpResponseBody, $httpResponse) = httpRequest("$vars{$env}{'url'}/mais/v1/fis/$vars{$env}{'fiid'}/layouts", \%httpHeaderHash, $agent, $readTimeOut, $httpContentType, 'GET', $httpBody, $outboundProxy);
...
if (1)
{
   ...
   #Send Request
   ($httpResCode, $httpResponseHeader, $httpResponseBody, $httpResponse) = httpRequest("$vars{$env}{'url'}/mais/v3/fis/$vars{$env}{'fiid'}/fiCustomers/$vars{$env}{'guid'}/messages?location=LOGOUT_PROMPT", \%httpHeaderHash, $agent, $readTimeOut, $httpContentType, 'GET', $httpBody, $outboundProxy);
