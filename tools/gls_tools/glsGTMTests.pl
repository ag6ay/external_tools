...
################################################################################
##                                                                            ##
##  glsGTMTests.pl - GLS GTM smoke tests used to validate GLS                 ##
##                   is functional against Global Traffic Manager.            ##
##                                                                            ##
##                   Created by: David Schwab                                 ##
##                   Last updated: DS - 04/16/2014 Ver. 1.0                   ##
##                                                                            ##
##                                                                            ##
################################################################################
################################################################################
...
$vars{'qa_qdc'}{'url'}                           = 'http://gl-qal-qydc.banking.intuit.net';
$vars{'qa_qdc'}{'auth'}                          = '8a60b1b3-0c36-4a5f-8c15-a5e13f62f489';
...
$vars{'qal1_dca_dcb'}{'url'}                     = 'http://gbl.qal1.diginsite.net';
$vars{'qal1_dca_dcb'}{'auth'}                    = '8a60b1b3-0c36-4a5f-8c15-a5e13f62f489';
...
$vars{'beta_qdc'}{'url'}                         = 'http://gl-beta-vip.ie.intuit.net:8080';
$vars{'beta_qdc'}{'auth'}                        = '00d62c44-c975-45d2-9827-6ff172a15908';
...
$vars{'stg1_dca'}{'url'}                         = 'http://gls.stg1.diginsite.net';
$vars{'stg1_dca'}{'auth'}                        = '3e0b4d247e6345bf81a37421700c8e12';

#################################################################
#Define prod_qdc_lvdc Variables below
#################################################################
$vars{'prod_qdc_lvdc'}{'guid'}                   = 'c0a8f208020600425228b11300440700';
$vars{'prod_qdc_lvdc'}{'fiid'}                   = '04090';
$vars{'prod_qdc_lvdc'}{'url'}                    = 'http://gl-prod-vip.ie.intuit.net';
$vars{'prod_qdc_lvdc'}{'auth'}                   = 'c8535b04-3a8d-4ea4-b593-b4690c40f770';

#################################################################
#Define prd1_dca_dcb Variables below
#################################################################
$vars{'prd1_dca_dcb'}{'guid'}                    = 'c0a8f208020600425228b11300440700';
$vars{'prd1_dca_dcb'}{'fiid'}                    = '04090';
$vars{'prd1_dca_dcb'}{'url'}                     = 'http://gbl.prd1.diginsite.net';
$vars{'prd1_dca_dcb'}{'auth'}                    = '3e0b4d247e6345bf81a37421700c8e12';
...
if (1)
{
   ...
   #Send Request
   ($httpResCode, $httpResponseHeader, $httpResponseBody, $httpResponse) = httpRequest("$vars{$env}{'url'}/glservice/status", \%httpHeaderHash, $agent, $readTimeOut, $httpContentType, 'GET', $httpBody, $outboundProxy);
...
if (1)
{
   ...
   #Send Request
   ($httpResCode, $httpResponseHeader, $httpResponseBody, $httpResponse) = httpRequest("$vars{$env}{'url'}/glservice/v1/fis/$vars{$env}{'fiid'}/products/IB/fiCustomers/$vars{$env}{'guid'}/auditData?startDate=1293868800000&endDate=1337670000000&event=login", \%httpHeaderHash, $agent, $readTimeOut, $httpContentType, 'GET', $httpBody, $outboundProxy);
...
{
   #Set Test Name
   $testName = 'getGLCatalogEvents-v1';
   ...
   #Send Request
   ($httpResCode, $httpResponseHeader, $httpResponseBody, $httpResponse) = httpRequest("$vars{$env}{'url'}/glservice/v1/catalog/events", \%httpHeaderHash, $agent, $readTimeOut, $httpContentType, 'GET', $httpBody, $outboundProxy);
...
{
   #Set Test Name
   $testName = 'getGLCatalogAttributes-v1';
   ...
   #Send Request
   ($httpResCode, $httpResponseHeader, $httpResponseBody, $httpResponse) = httpRequest("$vars{$env}{'url'}/glservice/v1/catalog/attributes", \%httpHeaderHash, $agent, $readTimeOut, $httpContentType, 'GET', $httpBody, $outboundProxy);
